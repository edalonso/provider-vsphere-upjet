...
// GetInitParameters of this ClusterVMGroup
func (tr *ClusterVMGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterVMGroup
func (tr *ClusterVMGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this ClusterVMGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ClusterVMGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &ClusterVMGroupParameters{}
