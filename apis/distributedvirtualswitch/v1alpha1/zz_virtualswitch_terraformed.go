...
// GetInitParameters of this VirtualSwitch
func (tr *VirtualSwitch) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VirtualSwitch
func (tr *VirtualSwitch) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VirtualSwitch using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VirtualSwitch) LateInitialize(attrs []byte) (bool, error) {
	params := &VirtualSwitchParameters{}
