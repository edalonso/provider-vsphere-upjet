...
// GetInitParameters of this PortGroup
func (tr *PortGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PortGroup
func (tr *PortGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this PortGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PortGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &PortGroupParameters{}
