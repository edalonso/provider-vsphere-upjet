...
type PortGroupInitParameters struct {
...
type PortGroupSpec struct {
	...
	// autoscaler.
	InitProvider PortGroupInitParameters `json:"initProvider,omitempty"`
}
...
// PortGroup is the Schema for the PortGroups API. Provides a vSphere distributed port group resource. This can be used to create and manage port groups on a vSphere Distributed Switch.
