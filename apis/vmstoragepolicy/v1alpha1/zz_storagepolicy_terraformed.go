...
// GetInitParameters of this StoragePolicy
func (tr *StoragePolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StoragePolicy
func (tr *StoragePolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this StoragePolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *StoragePolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &StoragePolicyParameters{}
