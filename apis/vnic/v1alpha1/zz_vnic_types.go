...
type VnicInitParameters struct {
...
type VnicSpec struct {
	...
	// autoscaler.
	InitProvider VnicInitParameters `json:"initProvider,omitempty"`
}
...
// Vnic is the Schema for the Vnics API. Provides a VMware vSphere vnic resource..
