...
// GetID returns ID of underlying Terraform resource of this Vnic
...
// GetInitParameters of this Vnic
func (tr *Vnic) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Vnic
func (tr *Vnic) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Vnic using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Vnic) LateInitialize(attrs []byte) (bool, error) {
	params := &VnicParameters{}
