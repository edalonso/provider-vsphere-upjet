...
// GetInitParameters of this ClusterVMDependencyRule
func (tr *ClusterVMDependencyRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterVMDependencyRule
func (tr *ClusterVMDependencyRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
