...
// GetInitParameters of this ClusterVMAntiAffinityRule
func (tr *ClusterVMAntiAffinityRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterVMAntiAffinityRule
func (tr *ClusterVMAntiAffinityRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
