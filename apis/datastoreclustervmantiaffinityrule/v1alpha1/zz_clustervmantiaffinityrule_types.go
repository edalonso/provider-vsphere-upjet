...
type ClusterVMAntiAffinityRuleInitParameters struct {
...
type ClusterVMAntiAffinityRuleSpec struct {
	...
	// autoscaler.
	InitProvider ClusterVMAntiAffinityRuleInitParameters `json:"initProvider,omitempty"`
}
...
// ClusterVMAntiAffinityRule is the Schema for the ClusterVMAntiAffinityRules API. Provides a VMware vSphere datastore cluster virtual machine anti-affinity rule. This can be used to manage rules to tell virtual machines to run on separate datastores.
