...
// GetInitParameters of this HostOverride
func (tr *HostOverride) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this HostOverride
func (tr *HostOverride) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this HostOverride using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HostOverride) LateInitialize(attrs []byte) (bool, error) {
	params := &HostOverrideParameters{}
