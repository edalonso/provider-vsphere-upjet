...
// GetInitParameters of this ClusterHostGroup
func (tr *ClusterHostGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterHostGroup
func (tr *ClusterHostGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this ClusterHostGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ClusterHostGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &ClusterHostGroupParameters{}
