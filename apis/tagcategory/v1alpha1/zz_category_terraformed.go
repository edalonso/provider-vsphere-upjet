...
// GetID returns ID of underlying Terraform resource of this Category
...
// GetInitParameters of this Category
func (tr *Category) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Category
func (tr *Category) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Category using its observed tfState.
