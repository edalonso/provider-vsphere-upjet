...
type VMOverrideInitParameters struct {
...
type VMOverrideSpec struct {
	...
	// autoscaler.
	InitProvider VMOverrideInitParameters `json:"initProvider,omitempty"`
}
...
// VMOverride is the Schema for the VMOverrides API. Provides a VMware vSphere HA virtual machine override resource. This can be used to override high availability settings in a cluster.
