...
// GetInitParameters of this VMOverride
func (tr *VMOverride) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VMOverride
func (tr *VMOverride) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VMOverride using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VMOverride) LateInitialize(attrs []byte) (bool, error) {
	params := &VMOverrideParameters{}
