...
// GetInitParameters of this Attribute
func (tr *Attribute) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Attribute
func (tr *Attribute) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Attribute using its observed tfState.
