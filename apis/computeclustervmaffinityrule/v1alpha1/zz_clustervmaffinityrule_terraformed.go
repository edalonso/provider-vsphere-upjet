...
// GetInitParameters of this ClusterVMAffinityRule
func (tr *ClusterVMAffinityRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterVMAffinityRule
func (tr *ClusterVMAffinityRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this ClusterVMAffinityRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ClusterVMAffinityRule) LateInitialize(attrs []byte) (bool, error) {
	params := &ClusterVMAffinityRuleParameters{}
