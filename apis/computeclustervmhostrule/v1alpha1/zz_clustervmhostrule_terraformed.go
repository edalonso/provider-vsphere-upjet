...
// GetInitParameters of this ClusterVMHostRule
func (tr *ClusterVMHostRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClusterVMHostRule
func (tr *ClusterVMHostRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this ClusterVMHostRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ClusterVMHostRule) LateInitialize(attrs []byte) (bool, error) {
	params := &ClusterVMHostRuleParameters{}
