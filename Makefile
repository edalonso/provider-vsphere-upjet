...
PROJECT_NAME ?= provider-vsphere-upjet
PROJECT_REPO ?= github.com/edalonso/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vsphere_v2.10.0
...
xpkg.build.provider-vsphere-upjet: do.build.images
